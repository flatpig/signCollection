...
var _0xod8 = 'jsjiami.com.v6',
  _0x435a = [
    ...
    'KCtAGFA=',
    'aF9zwoVnw5LDtl3Chw==',
    'woPkuK3kuZfot4zlu6fDiAtgYk/mn4Tor4zorojms6flpJzotLDDt+KCuu+7suKCm++5jg==',
    'UjXDnzbDkg==',
    'fcOdasKVWg==',
    'EMKbwovCpcOrwolHLA/ChsKPWQ==',
    '',
    '',
    ...
    'EcKkwqLCiVLDpsKk',
    'EHxBCw==',
    'w5VgwrYyYzbDqBnCtyIfwohdFMK+wrUQw58=',
    'w51qwrXDu8K1aWILwp8hEDJ5M8KGVw==',
    'wo5/Mwg1Bw==',
    'UVUmKsKc',
    'w7fCgDfCiC0=',
    'wr/CqhjDhV0=',
    'TQrDjQ/DoA==',
    'CU7CtA==',
    'w45wwqvDscKZcG4XwosyCzQ=',
    'f0p1wo0=',
    'w4HCncO+w5zCq8Oyd17CvE04w7E=',
    'ZeS6ruS7gui0teW7osOOT0kSwrjmn6jorKXor57msa/lpYrotI3Dn+KBiO+4quKBs++6ug==',
    'WgLDojXCjMOfPcK1diBXCw==',
    '',
    ...
    'w7IveEBcOg==',
    'NMOtw5g=',
    'YcO1w7bCjBXCj1rCusOuw5DCoWY=',
    'w4xQGTjCjg==',
    'TgDDujbCkMOeMcKsei5ODw==',
    'TQ7DojM=',
    'wqvCgSvCt8O1',
    'w65eJy3CpsKdQk92Z1VP',
    'N8Opw5gW',
    'TD7DjMOUXMOiwpU=',
    'wqbDnC8=',
    '6aOW5Y6i6YaY5bqP5om15Yuk',
    'wqPCpAPCicOEdsOnwooNwq/Cs8Oi',
    'w6QvYkU=',
    'HMOCXsKZWBc=',
    'XDLDlcOyWsOwwpXClcKow51TOQ==',
    '44KQ6aOI5Y+A6Ye15biy44GG',
    'w4PChgjCnTQDw60SWcKOw78z',
    'YQxpw4Y=',
    'bh3DuhXDpCw=',
    'IhEqw6sMDcORIsOtw7l/wog=',
    'YsOnR8OPw48=',
    'B8KawqbCmkc=',
    'CNjgLwsjiahmxwtUFi.kcom.vK6Wr==',
  ];
...
var _0x31f9 = function (_0x399ba0, _0x20111a) {
  ...
  if (_0x31f9['zPVvlF'] === undefined) {
    (function () {
      ...
      _0x210516['atob'] ||
        (_0x210516['atob'] = function (_0x20394a) {
          var _0x2b515a = String(_0x20394a)['replace'](/=+$/, '');
          for (
            var _0x1de264 = 0x0, _0x45341e, _0x202179, _0x2931f0 = 0x0, _0x25ac2b = '';
            (_0x202179 = _0x2b515a['charAt'](_0x2931f0++));
            ~_0x202179 && ((_0x45341e = _0x1de264 % 0x4 ? _0x45341e * 0x40 + _0x202179 : _0x202179), _0x1de264++ % 0x4) ? (_0x25ac2b += String['fromCharCode'](0xff & (_0x45341e >> ((-0x2 * _0x1de264) & 0x6)))) : 0x0
          ) {
    ...
    for (let item of shelfCategorys) {
      console.log(
        `  ${item['name'].length < 3 ? item['name'] + `\xa0` : item['name']}       ${
          item['shelfCategory'] === 1 ? '普通货架' : item['shelfCategory'] === 2 ? '冰柜货架' : item['shelfCategory'] === 3 ? '水果货架' : '未知货架'
        }       ${item['unlockStatus'] === 0 ? '---' : item['level'] + '级'}     ${item['unlockStatus'] === 0 ? '未解锁' : '已解锁'}      ${
          item['upgradeStatus'] === 1 ? '可以升级' : item['upgradeStatus'] === 0 ? '不可升级' : item['upgradeStatus']
        }`,
      );
    }
...
async function barGain() {
  let res = await getAuthorShareCode2('https://raw.githubusercontent.com/inoyna12/updateTeam/master/shareCodes/jd_barGain.json');
  if (!res) {
    $.http
      .get({ url: 'https://purge.jsdelivr.net/gh/inoyna12/updateTeam@master/shareCodes/jd_barGain.json' })
      .then(resp => {})
      .catch(e => $.log('刷新CDN异常', e));
    await $.wait(1000);
    res = await getAuthorShareCode2('https://cdn.jsdelivr.net/gh/inoyna12/updateTeam@master/shareCodes/jd_barGain.json');
  }
  ...
  for (let item of $.inBargaining) {
    ...
    const options = {
      ...
      headers: {
        ...
        'User-Agent':
          'jdapp;iPhone;9.4.0;14.3;;network/wifi;ADID/;supportApplePay/0;hasUPPay/0;hasOCPay/0;model/iPhone10,3;addressid/;supportBestPay/0;appBuild/167541;jdSupportDarkMode/0;Mozilla/5.0 (iPhone; CPU iPhone OS 14_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1',
...
async function bigWinner() {
  let res = await getAuthorShareCode2('https://raw.githubusercontent.com/inoyna12/updateTeam/master/shareCodes/bigWinner.json');
  if (!res) {
    $.http
      .get({ url: 'https://purge.jsdelivr.net/gh/inoyna12/updateTeam@master/shareCodes/bigWinner.json' })
      .then(resp => {})
      .catch(e => $.log('刷新CDN异常', e));
    await $.wait(1000);
    res = await getAuthorShareCode2('https://cdn.jsdelivr.net/gh/inoyna12/updateTeam@master/shareCodes/bigWinner.json');
  }
    ...
    $.get(
      {
        ...
        headers: {
          ...
          'user-agent':
            'jdltapp;iPhone;3.5.0;14.2;network/wifi;hasUPPay/0;pushNoticeIsOpen/0;lang/zh_CN;model/iPhone10,2;hasOCPay/0;appBuild/1066;supportBestPay/0;pv/7.0;apprpd/;Mozilla/5.0 (iPhone; CPU iPhone OS 14_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1',
          'accept-language': 'zh-cn',
