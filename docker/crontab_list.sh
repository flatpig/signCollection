...
0 0 1,3,5,7,16,19,22,23 * * * node /scripts/jx_cfd_pearl_exchange5.js >> /scripts/logs/jx_cfd_pearl_exchange5.log 2>&1
0 0 2,4,6,8,17,20,22,23 * * * node /scripts/jx_cfd_pearl_exchange1.js >> /scripts/logs/jx_cfd_pearl_exchange1.log 2>&1
