...
[task_local]
#取关京东店铺商品
55 23 * * * https://raw.githubusercontent.com/flatpig/signCollection/master/jd_unsubscribe.js, tag=取关京东店铺商品, enabled=true
// Loon
[Script]
cron "55 23 * * *" script-path=https://raw.githubusercontent.com/flatpig/signCollection/master/jd_unsubscribe.js,tag=取关京东店铺商品
// Surge
取关京东店铺商品 = type=cron,cronexp="55 23 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/flatpig/signCollection/master/jd_unsubscribe.js
 */
      ...
      if (goodPageSize * 1 !== 0) {
        if (followGoods.totalNum > 0) {
          for (let item of followGoods.data) {
            ...
            if (
              stopGoods &&
              item.commTitle.indexOf(stopGoods.replace(/\ufffc|\s*/g, '')) === 0
            ) {
              console.log(
