...
let cookiesArr = [];
const activityList = [{ actid: 'd68fd77329e347f2ba19ae65c1f8fa71', endTime: 1638374400000 }];
if ($.isNode()) {
...
function accessLogWithAD() {
  let config = {
    ...
    body: `venderId=${$.shopid}&code=69&pin=${encodeURIComponent($.pin)}&activityId=${$.activityID}&pageUrl=https://lzkjdz-isv.isvjcloud.com/wxFansInterActionActivity/activity/${$.activityID}?activityId=${
      $.activityID
