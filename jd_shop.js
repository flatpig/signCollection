/**
 ...
 [task_local]
 #进店领豆
 10 0 * * * https://raw.githubusercontent.com/flatpig/signCollection/master/jd_shop.js, tag=进店领豆, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_shop.png, enabled=true
 //Loon
 [Script]
 cron "10 0 * * *" script-path=https://raw.githubusercontent.com/flatpig/signCollection/master/jd_shop.js,tag=进店领豆
 //Surge
 进店领豆 = type=cron,cronexp="10 0 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/flatpig/signCollection/master/jd_shop.js
* */
const $ = new Env('进店领豆');
...
function getTask(body = {}) {
  return new Promise((resolve) => {
    const options = {
      url: `${JD_API_HOST}`,
      body: `functionId=queryTaskIndex&body=${escape(
        JSON.stringify(body)
      )}&appid=ld`,
      headers: {
        'User-Agent': 'JD4iPhone/167169 (iPhone; iOS 13.4.1; Scale/3.00)',
