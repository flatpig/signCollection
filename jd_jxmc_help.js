...
//     $.get(
//       {
//         url: 'https://raw.githubusercontent.com/inoyna12/updateTeam/master/shareCodes/' + name,
//         headers: {
...
async function takeGetRequest(type) {
  ...
  switch (type) {
    ...
    case 'DoTask':
      ...
      break;
    case 'Award':
      url = `https://m.jingxi.com/newtasksys/newtasksys_front/Award?_=${Date.now() + 2}&source=jxmc&taskId=${$.oneTask.taskId}&bizCode=jxmc&_stk=bizCode%2Csource%2CtaskId&_ste=1&jxmc_jstoken=${
        token.farm_jstoken
      }&timestamp=${token.timestamp}&phoneid=${token.phoneid}`;
      break;
    case 'cow':
