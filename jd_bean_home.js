...
!(async () => {
  ...
  $.authorCode = await getAuthorShareCode(
    'https://raw.githubusercontent.com/Aaron-lv/updateTeam/master/shareCodes/jd_updateBeanHome.json'
  );
  if (!$.authorCode) {
    $.http
      .get({
        url: 'https://purge.jsdelivr.net/gh/Aaron-lv/updateTeam@master/shareCodes/jd_updateBeanHome.json'
      })
      .then((resp) => {})
    ...
    $.authorCode =
      (await getAuthorShareCode(
        'https://cdn.jsdelivr.net/gh/Aaron-lv/updateTeam@master/shareCodes/jd_updateBeanHome.json'
      )) || [];
  }
  if (!cookiesArr[0]) {
    $.msg(
