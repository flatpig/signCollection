...
function doSupport(shareId) {
  return new Promise((resolve) => {
    $.post(
      taskPostUrl('doSupport', `shareId=${shareId}`),
      async (err, resp, data) => {
        try {
          if (err) {
...
function supportCheck(shareId) {
  return new Promise((resolve) => {
    $.post(
      taskPostUrl('supportCheck', `shareId=${shareId}`),
      (err, resp, data) => {
        try {
          if (err) {
            console.log(`${JSON.stringify(err)}`);
...
function browseSku(skuId) {
  return new Promise((resolve) => {
    $.post(
      taskPostUrl('browseSku', `skuId=${skuId}`),
      async (err, resp, data) => {
        try {
          if (err) {
            console.log(`${JSON.stringify(err)}`);
...
function getAuthorShareCode() {
  return new Promise((resolve) => {
    $.get(
      {
        url: 'https://cdn.jsdelivr.net/gh/shylocks/updateTeam@main/jd_digital_floor'
      },
      async (err, resp, data) => {
        try {
          if (err) {
