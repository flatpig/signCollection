...
更新地址：https://raw.githubusercontent.com/flatpig/signCollection/master/jd_joy_help.js
更新时间：2020-10-20
...
surge
[Script]
宠汪汪强制为别人助力= type=http-request,pattern=(^https:\/\/draw\.jdfcloud\.com\/\/pet\/enterRoom\/h5\?reqSource=weapp&invitePin=.*+(&inviteSource=task_invite&shareSource=\w+&inviteTimeStamp=\d+&openId=\w+)?|^https:\/\/draw\.jdfcloud\.com\/\/pet\/helpFriend\?friendPin),requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/flatpig/signCollection/master/jd_joy_help.js

圈x
[rewrite_local]
^https:\/\/draw\.jdfcloud\.com\/\/pet\/enterRoom\/h5\?reqSource=weapp&invitePin=.*+(&inviteSource=task_invite&shareSource=\w+&inviteTimeStamp=\d+&openId=\w+)?|^https:\/\/draw\.jdfcloud\.com\/\/pet\/helpFriend\?friendPin url script-request-header https://raw.githubusercontent.com/flatpig/signCollection/master/jd_joy_help.js

 LOON：
[Script]
http-request ^https:\/\/draw\.jdfcloud\.com\/\/pet\/enterRoom\/h5\?reqSource=weapp&invitePin=.*+(&inviteSource=task_invite&shareSource=\w+&inviteTimeStamp=\d+&openId=\w+)?|^https:\/\/draw\.jdfcloud\.com\/\/pet\/helpFriend\?friendPin script-path=https://raw.githubusercontent.com/flatpig/signCollection/master/jd_joy_help.js
...
const friendsArr = [
  ...
  '15975229552_p',
  'zdj8341',
  'pet_virtual_friend_胡皋三',
  'pet_virtual_friend_绿茶sama',
  ...
  '你要醒来',
  '338379384-148135',
  'pet_virtual_friend_乔治桑',
  'jd_54130a3e282ea',
  'jd_6169b3411ed5b',
  'jd_428d930ca56a5',
  'qq6924309',
  'pet_virtual_friend_路遇狗与少年',
  'jd_712bd3bfd55d6',
  'jd_4e97fe5ca4003',
  'tommy_he1',
  '13981372001_p',
