 ...
 * @Last Modified time: 2020-10-12 20:37:10
 ...
 [task_local]
 #摇京豆
 5 0 * * * https://raw.githubusercontent.com/flatpig/signCollection/master/jd_club_lottery.js, tag=摇京豆, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdyjd.png, enabled=true
 //Loon
 [Script]
 cron "5 0 * * *" script-path=https://raw.githubusercontent.com/flatpig/signCollection/master/jd_club_lottery.js,tag=摇京豆
 //Surge
 摇京豆 = type=cron,cronexp="5 0 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/flatpig/signCollection/master/jd_club_lottery.js
 * */
...
function taskUrl(function_id, body = {}) {
  return {
    url: `${JD_API_HOST}?functionId=${function_id}&appid=vip_h5&body=${escape(
      JSON.stringify(body)
    )}&_=${Date.now()}`,
    headers: {
      Cookie: cookie,
