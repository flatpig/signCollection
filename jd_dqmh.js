      ...
      try {
        if (err) {
          ...
          if (data && data.data['bizCode'] === 0) {
            ...
            } else if (data.result.taskToken) console.log(`任务请求成功，等待${$.duration}秒`);
            else {
...
function taskPostUrl3(function_id, body = {}, function_id2) {
  ...
  return {
    url,
    body: `functionId=${function_id}&body=${escape(JSON.stringify(body))}&client=wh5&clientVersion=10.0.0&uuid=${
      $.pre_session
    }&appid=shop_view&t=${new Date().getTime()}&eid=eidI374A0112Q0NGMzY5RTItQUNBOC00Nw%3D%3D4TVThAzwO7B3noqPTjLi8HvRnf5ZIdhigqvCSo4m5l2bJQJbD8a%2Frf9nqKqKh241mJSaOnR52SCzJYK0`,
    headers: {
      Accept: '*/*',
      'Accept-Encoding': 'gzip, deflate, br',
      'Accept-Language': 'zh-cn',
      ...
      Origin: 'https://wbbny.m.jd.com',
      Referer:
        'https://wbbny.m.jd.com/babelDiy/Zeus/2vVU4E7JLH9gKYfLQ5EVW6eN2P7B/index.html?babelChannel=jdappsyfc&shareType=team&inviteId=E7unasWZBJTSra-Ra-L5tMswsS-SlLJJjLHA&mpin=RnFjwjRbbjbZw9RV_sYmBgLc&from=sc&lng=116.381909&lat=39.971877&sid=848ed40bf83b638d83b87f0732342a2w&un_area=1_2810_55541_0',
      'User-Agent': $.isNode()
        ? process.env.JD_USER_AGENT
          ? process.env.JD_USER_AGENT
          : require('../USER_AGENTS').USER_AGENT
