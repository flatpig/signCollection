...
!(async () => {
  ...
  let res = [];
  try {
    res = await getAuthorShareCode('https://raw.githubusercontent.com/lsh26/share_code/main/vivo.json');
  } catch (e) {}
  if (!res) {
    try {
      res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/lsh26/share_code@main/vivo.json');
    } catch (e) {}
    if (!res) {
      res = [];
    }
  ...
  let res2 = [];
  try {
    res2 = await getAuthorShareCode('https://raw.githubusercontent.com/zero205/updateTeam/main/shareCodes/vivo.json');
  } catch (e) {}
  if (!res2) {
    try {
      res2 = await getAuthorShareCode('https://raw.fastgit.org/zero205/updateTeam/main/shareCodes/vivo.json');
    } catch (e) {}
    if (!res2) {
      res2 = [];
    }
